...
| **`MARATHON_FINISH_GRACE_MS`** | 137 | 40 seconden | De finish sluit dit lang na de winnaar. Een renner die één ronde achter zit, telt tóch mee in de uitslag (met zijn eigen, lagere aantal ronden) zodra de wedstrijd voorbij is en zijn eigen laatste ronde binnen dit venster rond de finish van de winnaar eindigde — vóór of ná dat moment. Een massasprint is niet in één klap voorbij: dit voorkomt dat iemand die een fractie van een seconde eerder over de finish kwam dan de winnaar zelf, onterecht als "gelapt" wordt weggezet. Maar het venster blijft ook niet eeuwig open: een doorkomst ná dit venster telt niet meer mee, welke ronde het ook echt was — zijn vorige (al wel echte) ronde blijft zijn laatste, en hij komt onderaan de lijst te staan, op volgorde van die laatste (nog wel geldige) doorkomst. |
