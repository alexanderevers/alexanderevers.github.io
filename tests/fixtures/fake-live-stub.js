 ...
 *
 * The account of 9002 (Sam Steady) and of 9102 (Bob Bouwer) has a name; the others have none.
 *
...
(() => {
    ...
    window.fetch = async input => {
        ...
        if (endpoint === 'account') {
            ...
            const names = { 'GA-9002': { givenName: 'Sam', surName: 'Steady' }, 'GA-9102': { givenName: 'Bob', surName: 'Bouwer' } };
